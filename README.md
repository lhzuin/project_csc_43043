...
git clone --recursive https://github.com/lhzuin/project_csc_43043.git


Controls
	•	Arrow Keys: Move the turtle on the X–Z plane
    •	First Player View in GUI: Changes the camera mode
...
│   ├── particles/      # Particle system code for bubbles
...
│   ├── particles/      # GPU‐driven bubble particle code
│   └── scene.cpp       # Main application loop, ImGui setup, game state
│
├── shaders/            # GLSL shaders
│   ├── actor/actor.vert.glsl
│   ├── actor/instanced_fish.vert.glsl
│   ├── mesh/custom_mesh.frag.glsl
│   ├── mesh/mesh.frag.glsl
│   ├── mesh/mesh.vert.glsl
│   ├── particle/particle.vert.glsl
│   └── particle/particle.frag.glsl
│
├── Makefile 
├── CMakeLists.txt      
└── README.md           
	...
	•	actors/
        ...
        •	npc/shark_actor.cpp/hpp, npc/angler_actor.cpp/hpp – specialized NPCs with skeletal animation groups and dynamic spawn decay.
